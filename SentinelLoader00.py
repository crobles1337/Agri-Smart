...
newfile, fpath = sl.getProductBandTiles(area, 'B08', '10m', userdate)
print("this is the list", newfile)

f2, fpath = sl.getProductBandTiles(area, 'B04', '10m', userdate)
print("this is the next list", f2)
